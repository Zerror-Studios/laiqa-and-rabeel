...
//                Join us in Marrakech, among the olive groves and Atlas Mountains, beginning with the Mehendi and Sangeet on Saturday, followed by the Wedding Ceremony and Reception on Sunday.
//               </p>
//             </div>
//           </div>
  ...
  return (
    <>
      <div className="w-full min-h-screen relative MMAINDDiv overflow-x-hidden">
        ...
        {/* Cards Section */}
        <div className="w-full h-fit COLOR_BG_RED relative z-100 flex flex-col items-center px-10 py-20 max-md:px-6 max-md:py-10">

          <p className=" Font_Q capitalize italic COLOR_TEXT_RED text-[2vw] leading-[2.5vw]  pb-10 sm:hidden text-center ">Click on the cards below for more information on each event</p>

          <div className="w-full max-w-[1300px] mx-auto grid grid-cols-4 max-md:grid-cols-1 gap-6 max-md:gap-10">

            <CardGroup>

              {/* T1 — Mehndi Lunch */}
              <FlipCard className="w-full h-[48vh] min-h-[380px] max-h-[520px] max-md:h-[50vh] max-md:min-h-[420px]">
                {/* FRONT */}
                <div className="absolute inset-0 bg-white border border-[#044BB2] py-10 px-6 flex flex-col justify-between">
                  <div className="w-full h-fit flex flex-col">
                    <h1 className="text-[2.4vw] leading-[2.4vw] max-md:text-center max-md:text-[7vw] max-md:leading-[7vw] Font_Q COLOR_TEXT_RED">
                      Mehendi
                    </h1>
                    <span className="text-[14px] leading-[16px] max-md:text-center max-md:text-[4vw] Font_YV COLOR_TEXT_RED">
                      Saturday, November 14th, 2026
                  ...
                  <div className="w-full flex justify-end max-md:justify-center items-end">
                    <img src="/assets/s10.png" className="w-[65%] object-cover" />
                  </div>
                </div>
                {/* BACK */}
              ...
              <FlipCard className="w-full h-[48vh] min-h-[380px] max-h-[520px] max-md:h-[50vh] max-md:min-h-[420px]">
                ...
                <div className="absolute inset-0 bg-white border border-[#044BB2] py-10 px-6 flex flex-col justify-between">
                  ...
                  <div className="w-full flex justify-end max-md:justify-center items-end">
                    <img src="/assets/s35.png" className="w-[65%] object-cover" />
                  </div>
                </div>
                {/* BACK */}
                <div className="absolute inset-0 text-[#044BB2] overflow-hidden flex items-center justify-center p-6">
              ...
              <FlipCard className="w-full h-[48vh] min-h-[380px] max-h-[520px] max-md:h-[50vh] max-md:min-h-[420px]">
                ...
                <div className="absolute inset-0 bg-white border border-[#044BB2] py-10 px-6 flex flex-col justify-between">
                  <div className="w-full h-fit flex flex-col">
                    ...
                    <span className="text-[14px] max-md:text-center max-md:text-[4vw] Font_YV COLOR_TEXT_RED">
                      Sunday, November 15th, 2026
                    </span>
                  </div>
                  <div className="w-full flex justify-end max-md:justify-center items-end">
                    <img src="/assets/s05.png" className="w-[42%] object-center object-cover" />
                  </div>
                </div>
                {/* BACK */}
                <div className="absolute inset-0 text-[#044BB2] overflow-hidden flex items-center justify-center p-6">
              ...
              <FlipCard className="w-full h-[48vh] min-h-[380px] max-h-[520px] max-md:h-[50vh] max-md:min-h-[420px]">
                ...
                <div className="absolute inset-0 bg-white border border-[#044BB2] py-10 px-6 flex flex-col justify-between">
                  <div className="w-full h-fit flex flex-col">
                    <h1 className="text-[2.4vw] leading-[2.4vw] max-md:text-[7vw] max-md:leading-[7vw] Font_Q COLOR_TEXT_RED">
                      Reception Dinner
                    </h1>
                    <span className="text-[14px] max-md:text-[4vw] Font_YV COLOR_TEXT_RED">
                      Sunday, November 15th, 2026
                  ...
                  <div className="w-full flex justify-end max-md:justify-center items-end">
                    <img src="/assets/s19.png" className="w-[65%] object-cover" />
                  </div>
                </div>
                {/* BACK */}
                <div className="absolute inset-0 text-[#044BB2] overflow-hidden flex items-center justify-center p-6">
